...
help:
	...
	@echo "  make test-api       - Run interactive API tests (requires service running)"
...
fixtures:
	...
	@echo "  - Company configs for companies 1, 2, 3"
	@echo "  - 10 test bookings with different statuses"
	@echo "  - See migrations/fixtures/README.md for details"
...
test-smoke:
	...
	@chmod +x test_data/api_requests.sh
	@bash -c "source test_data/api_requests.sh && run_smoke_tests"
